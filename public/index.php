...
// Se incluye el archivo para la utilización de funciones especiales
include_once '../app/helpers.php';

// // Se inicia la sesión
// session_start();

// Se utiliza esta función para incluir todos los controladores que se desean agregar automáticamente
foreach (glob("../controllers/*.php") as $filename)
    include_once '../controllers/'.$filename;


// Se utiliza esta función para incluir todos los modelos que se desean agregar automáticamente
